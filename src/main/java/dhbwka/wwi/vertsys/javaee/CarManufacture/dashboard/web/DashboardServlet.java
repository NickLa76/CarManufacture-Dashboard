 ...
 */
package dhbwka.wwi.vertsys.javaee.CarManufacture.dashboard.web;
...
public class DashboardServlet extends HttpServlet {
    ...
    @EJB(beanName = "bookings")
    DashboardContentProvider bookingContent;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        bookingContent.createDashboardContent(sections);
